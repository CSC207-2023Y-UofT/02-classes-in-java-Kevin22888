...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes two strings as arguments, and
     * sets the name of the Silly object as the concatenation
     * of the two strings.
     *
     * @param name1 a string for the first part of the Silly
     *              instance's name
     * @param name2 a string for the second part of the Silly
     *              instance's name
     */
